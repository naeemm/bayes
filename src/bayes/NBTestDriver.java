...
public class NBTestDriver extends Configured implements Tool{
	...
	public int run(String[] arg0) throws Exception {
		...
		JobConf conf = new JobConf(getConf(),NBTestDriver.class);
		...
		conf.setMapperClass(NBTestMapper.class);
		// 	conf.setReducerClass(NBTestReducer.class);
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new NBTestDriver(), args);
		System.exit(res);
	}
	////////////////////////////////////////////////////////////////
}
